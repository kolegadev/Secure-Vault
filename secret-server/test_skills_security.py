#!/usr/bin/env python3
"""
Test script to verify path traversal vulnerability in skills.py is fixed
"""
import sys
import os
import tempfile
...
from secret_server.api.skills import _validate_path_component, _validate_file_path
